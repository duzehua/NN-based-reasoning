...
* Date: Jun. 28, 2022  
*/
int ExtractNumFromChar(char *Str, int idx_start, int idx_end)
{
...
* Warning: 未添加异常判断和处理！！！
*/
int FindCharIdxInStr(char *Str, char Char, int idx_start, int idx_num, int descend_flag)
{
    char *curt_num_addr;
    int   idx_curt_num;
...
* Date: Jun. 28, 2022  
*/
void ExtractShapeFromCharForTensor(char *f_path_name, int *shape_tensor)
{
    // 拆分文件名
